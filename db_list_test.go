...
// 		res, err := db.LPush(key, int64(2), 36.2, int32(15), uint8(1), "asd", "coco")
// 		if err != nil {
// 			log.Fatal(err)
// 		}
...
// 	_, err := db.RPush(key, []byte("list_data_0011"), []byte("list_data_0022"), []byte("list_data_0033"), "123", 11, 22.5, false)
// 	if err != nil {
// 		log.Fatal(err)
// 	}
...
// 	key := []byte("mylist")
// 	ok := db.LValExists(key, []byte("cocs1o"))
// 	t.Log(ok)
