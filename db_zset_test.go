...
// 	db.ZRevRank(nil, nil)
// 	rank := db.ZRevRank(key, []byte("Python"))
// 	t.Log(rank)
...
// 	recScoreRange := func(min, max float64) {
// 		vals := db.ZRevScoreRange(key, min, max)
// 		for _, v := range vals {
// 			t.Logf("%+v ", v)
// 		}
// 	}

// 	db.ZRevScoreRange(nil, -1, 0)
// 	recScoreRange(50, 100)
// 	recScoreRange(200, 260)
