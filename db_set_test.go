...
// 	_, _ = db.SAdd([]byte("my_set1"), []byte("set_data_007"), []byte("set_data_008"), []byte("set_data_009"))
// 	_, _ = db.SAdd([]byte("my_set2"), []byte("set_data_009"))
